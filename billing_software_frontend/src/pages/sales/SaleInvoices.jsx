...
export default function SaleInvoices() {
  ...
  const {
    ...
    setShowColumnDrawer,
    visibleColumnCount,
  } = useTableColumns("sale_invoice_columns", DEFAULT_COLUMNS);
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-4 sm:p-6 font-['Plus_Jakarta_Sans',sans-serif]">
                    ...
                    >
                      ...
                      {visibleColumns.status && (
                        <td className="py-3.5 px-3.5 border-r border-slate-200 whitespace-nowrap">
                          {isPaid ? (
                            <span className="app-badge-success">Paid</span>
                          ) : isUnpaid ? (
                            <span className="app-badge-danger">Unpaid</span>
                          ) : (
                            <span className="app-badge-warning">Partial</span>
                          )}
                        </td>
                      )}
      ...
      {/* ── RIGHT-SIDE COLUMN CUSTOMIZATION DRAWER ── */}
      <CommonTableColumnSettings
        ...
        title="Table Columns"
        subtitle="Show or hide columns in your sales list"
      />
