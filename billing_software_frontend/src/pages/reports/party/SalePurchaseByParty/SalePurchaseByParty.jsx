...
import SalePurchaseByPartyAnalytics from "./SalePurchaseByPartyAnalytics";
  ...
  return (
    <div className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 space-y-3.5 max-w-[1600px] mx-auto text-slate-800">
      {viewMode === "analytics" ? (
        ...
        <>
      <h1 className="text-xl md:text-2xl font-bold text-slate-900 mt-1 tracking-tight">Sale Purchase By Party</h1>
      {/* ═══════════════════════════════════════════════════════════════
          1. HEADER & FILTER BAR
          ═══════════════════════════════════════════════════════════════ */}
