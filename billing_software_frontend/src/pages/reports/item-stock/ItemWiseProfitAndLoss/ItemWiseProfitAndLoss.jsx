...
import ItemWiseProfitAndLossAnalytics from "./ItemWiseProfitAndLossAnalytics";
...
export default function ItemWiseProfitAndLoss() {
  ...
  return (
    <div className="px-2 sm:px-3 md:px-4 py-2 sm:py-3 space-y-3.5 max-w-[1600px] mx-auto text-slate-800 font-sans">
      {viewMode === "analytics" ? (
        <ItemWiseProfitAndLossAnalytics
          rows={analyticsRows}
          period={metaLabel}
        ...
        <>
      <h1 className="text-xl md:text-2xl font-bold text-slate-900 mt-1 tracking-tight">Item Wise Profit And Loss</h1>
      {/* Filter Card */}
