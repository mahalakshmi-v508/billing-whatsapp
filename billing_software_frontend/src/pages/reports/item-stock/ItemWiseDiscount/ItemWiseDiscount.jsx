...
import ItemWiseDiscountAnalytics from "./ItemWiseDiscountAnalytics";
...
export default function ItemWiseDiscount() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-6 max-w-[1600px] mx-auto text-slate-800 font-sans">
      {viewMode === "analytics" ? (
        <ItemWiseDiscountAnalytics
          rows={analyticsRows}
          period={`${displayDate(formatDate(startDate))} → ${displayDate(formatDate(endDate))}`}
